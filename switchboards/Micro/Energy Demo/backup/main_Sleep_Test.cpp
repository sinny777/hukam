...
#define wifi_ssid "GurvinderNet"         //wifi ssid
#define wifi_password "1SatnamW"     //wifi password

#define mqtt_server "iot.eclipse.org"  // server name or IP
...
#define TIME_TO_SLEEP_ERROR 60       /* Time to sleep in case of error (1 hour) */
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect("ESP32ClientOfGurvinder", mqtt_user, mqtt_password)) {
